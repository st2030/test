                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                           ...
                           <?php foreach($authors as $author):?>
                            <?php if($author["status"]=="banned"):?>
                            <div class="<?php echo $author["status"];?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                            <?php else:?>
